...
export default function HomePage() {
  ...
  const steps = [
    ...
    { icon: "🗺️", title: t("home.step4Title"), desc: t("home.step4Desc") },
  ];
    ...
    <main className="flex flex-col min-h-screen">
      ...
      <section className="flex flex-col items-center justify-center flex-1 px-6 pt-20 pb-16 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          ...
          {/* Date de lancement — calculée dynamiquement, jamais baked-in */}
          <p className="mt-8 text-sm text-white/40" suppressHydrationWarning>
            {launchDateStr}
          </p>
